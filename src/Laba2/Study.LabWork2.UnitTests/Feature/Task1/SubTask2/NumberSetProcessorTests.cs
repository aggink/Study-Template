...
public sealed class NumberSetProcessorTests
{
    ...
    [Test]
    public void Process_EmptySets_ThrowsException()
    {
        NumberSetProcessor processor = new();

        IReadOnlyList<IReadOnlyList<int>> numberSets = new List<IReadOnlyList<int>>();

        Assert.Throws<Exception>(() => processor.Process(numberSets, maxParallelThreads: 3));
    }

    [Test]
    public void Process_WrongSetsCount_ThrowsException()
    {
        NumberSetProcessor processor = new();
    ...
    [Test]
    public void Process_WrongNumbersCountInSet_ThrowsException()
    {
        NumberSetProcessor processor = new();
    ...
    [Test]
    public void Process_NumberLessThanOne_ThrowsException()
    {
        NumberSetProcessor processor = new();
    ...
    [Test]
    public void Process_NumberGreaterThanOneHundred_ThrowsException()
    {
        NumberSetProcessor processor = new();
    ...
    [Test]
    public void LoadNumberSets_FileWithNumberLessThanOne_ThrowsInvalidOperationException()
    {
        string filePath = CreateTempFilePath();
        ...
        {
            List<string> lines = CreateFileLines();
            lines[0] = string.Join(' ', Enumerable.Repeat(0, 100));
    ...
    [Test]
    public void LoadNumberSets_FileWithNumberGreaterThanOneHundred_ThrowsInvalidOperationException()
    {
        string filePath = CreateTempFilePath();
